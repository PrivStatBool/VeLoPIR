...
int main() {
    ...
    std::ofstream file("result/LocPIRbb3_timing_us.csv");
    file << "Mode,Time(s)\n";  // CSV header

    // Provide the path to the CSV file
    std::string filename = std::string(DATA_DIR) + "/us_coordinate_with_confirmed_bb3.csv";
    ...
    // Encrypted ID for the query (e.g., for a specific city with a known encoding)
    ...
    std::cout << "Test completed and results saved to result/LocPIRbb3_timing_us.csv" << std::endl;

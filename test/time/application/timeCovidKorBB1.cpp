...
int main() {
    ...
    std::ofstream file("result/LocPIRbb1_timing_covid_korea.csv");
    file << "Mode,Time(s)\n";  // CSV header
    ...
    std::cout << "Test completed and results saved to result/LocPIRbb1_timing_covid_korea.csv" << std::endl;
    return 0;
}
